...
def replace_url(json_data, value_to_replace, new_value):
    """
...
replaced_file_path = chains_file_path # Temporarly set the same path to upda provided file

with open(chains_file_path, 'r') as f:
    data = json.load(f)

replace_url(data, new_domain)
